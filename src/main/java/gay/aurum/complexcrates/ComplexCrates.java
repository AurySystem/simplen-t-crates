...
public class ComplexCrates implements ModInitializer {
	...
	static GlobalStorage GLOBALSTOR;
	...
	public static final Block NETHERITE_CRATE = createCrate(
			"netherite_crate", new ExtendedCrateBlock(FabricBlockSettings.copyOf(Blocks.NETHERITE_BLOCK), 64*27*6));
	...
	public static final Item NETHERITE_CRATE_ITEM = Registry.register(
			Registry.ITEM, id("netherite_crate"), new BlockItem(NETHERITE_CRATE, new FabricItemSettings().fireproof().group(ItemGroup.DECORATIONS)));
	...
	public void onInitialize() {
		...
		ServerLifecycleEvents.SERVER_STARTED.register(server -> {
			GLOBALSTOR = (GlobalStorage) server.getWorld(World.OVERWORLD).getPersistentStateManager().getOrCreate(GlobalStorage::readNbt, GlobalStorage::new, MODID+"-ender-crates");
		});
